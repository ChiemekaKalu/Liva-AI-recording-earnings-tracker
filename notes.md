...
Q. When does fraud detected? 
A. The second, since we need both end times for the overlap test.


Q. What if the user already withdrew their fraudlent funds before the second recording is done?
a. Deduct what we can, floor at zero, and move on. 
